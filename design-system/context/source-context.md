...
- Source project id: f1be645a-72a9-4a06-bbf9-09c525ecc4c4
- Source project name: Design This App
- New design-system project id: 8d0b88c3-2093-4859-8805-31a04591c6d6
- New design-system id: user:design-this-app-design-system
...
```json
{
  ...
  "nameSource": "prompt",
  "linkedDirs": [
    "/Users/raymondong/code/rayjosong/projects/korean-learning-app"
  ]
}
```
...
- korean-reading-room-v2.html
- korean-reading-room.html
- brand-spec.md
