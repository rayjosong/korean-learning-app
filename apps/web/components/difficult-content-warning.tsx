...
export function DifficultContentWarning({
  ...
  const estimateLabel = estimate.source === "personalized" ? "personalized" : "starter";
  ...
  return (
    <section className="rounded-xl border border-hairline-strong bg-highlight-soft p-4" role="alert" aria-label="Difficult content notice">
      ...
      <p className="mt-1 text-sm leading-6 text-ink-secondary">
        The {estimateLabel} estimate suggests about {estimate.likelyComprehension.min}–{estimate.likelyComprehension.max}% may be familiar at first. Try a shorter session or look up a few extra words as you go.
      </p>
